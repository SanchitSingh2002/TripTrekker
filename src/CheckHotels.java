...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run()
    {
        ...
        String[] text = {"JW Marriott Hotel", "Madirin Orientel Hotel", "Four Seasons Hotel", "Raddison Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel" };
        try
        {
            for (int i = 0; i<=9; i++)
            {
    ...
    CheckHotels()
    {
        ...
        caption = new JLabel();
        caption.setBounds(50, 600, 1000, 70);
